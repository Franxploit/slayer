...
const token = '7488413334:AAHVeUWH3y_WBqIwLmi1iJ3VBhbxsBuBUcE';
...
╔══════════════════════════════╗
  ＦＲＡＮＸＰＬＯＩＴ - ＶＩＲＵS ⛧⃝𓃶 G O D
╚══════════════════════════════╝
» 𝙳𝙳𝙾𝚂 + ⛧⃝𓄃𝚇𝙿𝙻𝙾𝙸𝚃 𝙼𝙸𝚇𝚃𝙾𝙾𝙻 «
✧ /mixddos  ➙ Hybrid Attack Mode  
✧ /httpcrash ➙ Host Vulnerability Scan  
✧ /bugcrash  ➙ (𝚄𝙽𝚂𝚃𝙰𝙱𝙻𝙴-𝙼𝙾𝙳𝙴)  
✧ /sendnuke  ➙ [𝚃𝙰𝚁𝙶𝙴𝚃-𝙸𝙳]  
✧ /franxmode ➙ 𝗨𝗟𝗧𝗜𝗠𝗔𝗧𝗘 𝗖𝗥𝗔𝗦𝗛𝗘𝗥  

🔥 𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: @Akumanusia3  
⚠️ 𝗨𝗦𝗘 𝗪𝗜𝗧𝗛 𝗖𝗔𝗨𝗧𝗜𝗢𝗡!`)
}
